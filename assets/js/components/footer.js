  ...
  return `
    <div class="footer">
      <div class="footer__container">
        ...
        <!-- Sección: Contacto CON íconos a la derecha -->
        <section class="footer__section footer__section--contact">
          ...
          <div class="footer__contact-wrapper">
            ...
            <!-- SVGs de redes sociales (derecha) -->
            <div class="footer__social">
              <a href="https://www.facebook.com/profile.php?id=61578116663335" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="30" height="30" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
              ...
              <a href="https://www.instagram.com/ixel.mx/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="mailto:contacto@ixelartesanias.com" aria-label="Email">
                <svg width="30" height="30" viewBox="0 -4 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="http://wa.me/523330336808" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                <svg width="30" height="30" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
